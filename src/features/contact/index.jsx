    ...
    <>
      <SectionWrapper title="Get In Touch">
        <div className="contact-grid">
          ...
          <a href={personal.leetcode} target="_blank" rel="noreferrer" className="contact-card">
            <div className="contact-card-icon" style={{ background: '#FFA116' }}>LC</div>
            <div>
              <h4 className="contact-card-label">LeetCode</h4>
              <p className="contact-card-value">{personal.leetcodeHandle}</p>
            </div>
          </a>

          <a href={`tel:${personal.phone.replace(/\s/g, '')}`} className="contact-card">
            <div className="contact-card-icon" style={{ background: '#a855f7' }}>☎</div>
            <div>
              <h4 className="contact-card-label">Phone</h4>
              <p className="contact-card-value">{personal.phone}</p>
            </div>
          </a>
      ...
      <SectionWrapper>
        <div style={{ textAlign: 'center', padding: '20px 0' }}>
          ...
          <p style={{ marginBottom: 24 }}>
            I'm always interested in backend engineering roles, applied AI work, and collaborating on
